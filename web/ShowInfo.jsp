                        ...
                        <div class="panel-body">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <form action="showInfoToUpdate" method="post" class="form-signup">
                                        <h1 class="h3 mb-3 font-weight-normal" style="text-align: center">
                                            Information</h1>
                                        <h5>UserID : ${sessionScope.acc.getId()} <a href=""></a></h5> 
                                        <h5>Full name : ${userInfo.fullName} <a href=""></a></h5> 
                                        <h5>Address : ${userInfo.address} <a href=""></a></h5> 
                                        <h5>Mobile : ${userInfo.mobile} <a href=""></a></h5> 

                                        <c:if test="${sessionScope.acc.getIsSell() == 1 && sessionScope.acc.getIsAdmin() == 0}" >
                                            <h5>Role : Sell</h5>
                                        </c:if>

                                        <c:if test="${sessionScope.acc.getIsSell() == 0 && sessionScope.acc.getIsAdmin() == 1}" >
                                            <h5>Role : Admin</h5>
                                        </c:if>

                                        <c:if test="${sessionScope.acc.getIsSell() == 1 && sessionScope.acc.getIsAdmin() == 1}" >
                                            <h5>Role : Sell and Admin</h5>
                                        </c:if>
